...
assets/
  ...
  wardrobe-planner.pdf  the 4-page wardrobe planner
  planner/1-4.jpg       the same pages as images, shown on wardrobe.html
...
is exactly what that tap is for — and loops back to the 20-second mark each time it ends. A
...
- **Wardrobe planner** — a button under the schedule opens `wardrobe.html`, which shows the
  four planner pages and offers `assets/wardrobe-planner.pdf` as a download. To change the
  planner, replace those four JPEGs in `assets/planner/` and the PDF.
...
Wikimedia Commons. The wardrobe planner pages come from the PDF you supplied, with the
monogram, hashtag, names and dates replaced. Type is [Satoshi](https://www.fontshare.com/fonts/satoshi) by Indian Type
